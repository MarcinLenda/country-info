...
public class CountryISOCodeResponse {
     ...
     *     
     */
    public Optional<String> getCountryISOCodeResult() {
        if(notFound()) {
            return Optional.empty();
        }
        return Optional.of(countryISOCodeResult);
    }

    private boolean notFound() {
        return countryISOCodeResult == null ||
                countryISOCodeResult.isEmpty() ||
                "No country found by that name".equals(countryISOCodeResult);
    }
